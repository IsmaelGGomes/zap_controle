...
<div class="min-h-screen bg-white flex">
    <div class="hidden lg:block relative w-0 flex-1 bg-white text-white">
        <div class="flex h-full justify-center items-center">
            <img src="https://zapfretes.com.br/suporte/images/login/undraw_Visionary_technology_re_jfp7.png" alt="">
        </div>
    </div>
        ...
        <div class="mx-auto w-full max-w-sm lg:w-96">
            <div class="">
                <div class="flex justify-center">
                    <img src="https://zapfretes.com.br/suporte/images/login/logo_zapfrete.png" alt=""
