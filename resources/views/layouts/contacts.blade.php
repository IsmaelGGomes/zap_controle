    ...
    <div class="mx-auto max-w-screen-xl px-4 py-4 sm:px-6 lg:px-8">
        <div class="mx-auto max-w-lg">
            <div class="flex flex-col">
                <img class="" src="https://zapfretes.com.br/suporte/images/login/logo_zapfrete.png" alt="">
            ...
            <form action="https://zapfretes.com.br/suporte/dashboard" method="POST" class="mb-0 mt-6 bg-white space-y-4 rounded-lg p-4 shadow-lg sm:p-6 lg:p-8">
                ...
                <div>
                    <div class="relative">
                        ...
                        <input name="filial" type="text" value="{{ old('filial') }}"
                            class="{{ $errors->first('filial') ? 'w-full rounded-lg border-2 border-red-500 p-4 text-sm text-black shadow-md' : 'text-black w-full rounded-lg border-none p-4 pe-12 text-sm shadow-md' }}"
