<x-app-layout>
    ...
    <div class="py-12 w-full px-2 flex flex-row h-auto bg-[#1d232a]">
        <div class="flex flex-col">
            <div class="flex flex-col w-40 ml-14 mb-4 space-y-2">
                <div onclick="viewAddAtendente()" class="inline-flex items-center justify-center w-full px-2 py-1 mb-2 text-md text-white bg-green-500 rounded-md hover:bg-green-400 sm:w-auto sm:mb-0 cursor-pointer transition duration-300 ease-in-out transform hover:scale-110">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 mr-2">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M12 9v6m3-3H9m12 0a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
                    </svg>
                    Atendentes
                </div>
                <div onclick="viewAddWebhook()" class="inline-flex items-center justify-center w-full px-2 py-1 mb-2 text-md text-white bg-violet-800 rounded-md hover:bg-violet-900 sm:w-auto sm:mb-0 cursor-pointer transition duration-300 ease-in-out transform hover:scale-110">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 mr-2">
            ...
            <form action="{{ config('app.url') }}/dashboard" method="get" class="bg-gray-200 rounded-xl py-2 justify-center items-center flex flex-col gap-8 px-4 h-auto w-[200px] mr-10 ml-8">
                <div class="w-40 h-[18%] p-4 border border-2 border-gray-400 justify-center flex flex-col rounded-xl items-center">
                ...
                <div class="w-40 h-[18%] p-4 border border-2 border-gray-400 justify-center flex flex-col rounded-xl items-center">
                    ...
                    <div class="w-[120px]">
                        <select class="w-full select" name="transportadora" id="">
                            ...
                            <option value="JB_Cargas">JB Cargas</option>
                            <option value="Anderle">Anderle</option>
                        </select>
                    </div>
                </div>
                <div class="w-40 h-[18%] p-4 border border-2 border-gray-400 justify-center flex flex-col rounded-xl items-center">
                ...
                <div class="w-40 h-[18%] p-2 border border-2 border-gray-400 justify-center flex flex-col rounded-xl items-center">
                    <div class="mb-4 text-gray-700 font-semibold">
                        Status
                    </div>
                    <div class="w-[120px]">
    ...
    <div id="add_atendente" class="fixed hidden inset-0 z-10 bg-gray-500 bg-opacity-50 h-screen w-full overflow-y-auto ">
        <div class="absolute rounded-md bg-white md:left-[50%] left-1/2 md:top-[48%] top-1/2 md:translate-y-[-50%] md:translate-x-[-50%] w-auto h-auto translate-y-[-40%] translate-x-[-41%]">
            <div class="px-10 py-4 rounded-xl">
                <div class="flex flex-row justify-end">
                    <svg onclick="viewAddAtendente()" class="cursor-pointer w-6 h-6" aria-hidden="true" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="flex flex-col border border-1 px-10 py-2 rounded-md">
                        ...
                        <form method="POST" action="{{ config('app.url') }}/atendente">
                            ...
                            <div class="relative z-0 w-full mb-6 group">
                                <input id="atendente" type="text" name="atendente" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 
                            ...
                            <div class="relative z-0 w-full mb-6 group">
                                <input id="numero_atendente" type="text" name="numero_atendente" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 
                            border-gray-500 focus:border-blue-500 text-black focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" ">
                                ...
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <form action="{{ config('app.url') }}/atendente/{{$items->id}}" method="post">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" class="ml-2 px-2 py-[2px] font-medium text-white bg-red-600 rounded-md hover:bg-red-500 focus:outline-none focus:shadow-outline-red active:bg-red-600 transition duration-150 ease-in-out">Excluir
                                            </button>
                                        </form>
                                    </td>
                                </tr>
    ...
    <div id="add_webhook" class="fixed hidden inset-0 z-10 bg-gray-500 bg-opacity-50 h-screen w-full overflow-y-auto ">
        <div class="absolute rounded-md bg-white md:left-[50%] left-1/2 md:top-[48%] top-1/2 md:translate-y-[-50%] md:translate-x-[-50%] w-auto h-auto translate-y-[-40%] translate-x-[-41%]">
            <div class="px-10 py-4 rounded-xl">
                <div class="flex flex-row justify-end">
                    <svg onclick="viewAddWebhook()" class="cursor-pointer w-6 h-6" aria-hidden="true" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        <path d="M6 18L18 6M6 6l12 12" stroke-linecap="round" stroke-linejoin="round">
                        </path>
                    </svg>
                </div>
                <div class="flex flex-row gap-8">
                    <div class="flex flex-col border border-1 px-10 py-2 rounded-md">
                        ...
                        <form method="POST" action="{{ config('app.url') }}/webhook">
                            ...
                            <div class="relative z-0 w-full mb-6 group">
                                <input id="webhook_usuario" type="text" name="webhook_usuario" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 
                            border-gray-500 focus:border-blue-500 text-black focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" ">
                                <label for="" class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">
                                    Webhook Usuario</label>
                            </div>
                            <div class="relative z-0 w-full mb-6 group">
                                <input id="webhook_atendente" type="text" name="webhook_atendente" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 
                            border-gray-500 focus:border-blue-500 text-black focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" ">
                                <label for="" class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">
                            ...
                            <div class="px-4  w-full rounded-xl">
                                <form action="#" method="" enctype="multipart/form-data">
                                    ...
                                    <div class="flex flex-row gap-10">
                                        <div class="relative z-0 w-full mb-4 group">
                                            <input id="cidade" type="text" name="cidade" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 
                                        border-gray-500 focus:border-blue-500 text-black focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" ">
